...
impl Into<&'static str> for InternalGlobalConst {
    fn into(self) -> &'static str {
        match self {
            ...
            InternalGlobalConst::ListOpeningStr => internal_global_prefix!("list_open_brace_string"),
            InternalGlobalConst::ListClosingStr => internal_global_prefix!("list_close_brace_string"),
            InternalGlobalConst::ListSeparatorStr => internal_global_prefix!("list_separator_string"),
